 ...
 * @version 1.0
 */
public abstract class DrawCoordinates
	{
	/**
	 ...
	 */
	public static Position pixToField(int iPanelSzerokosc, int iPanelWysokosc, int iPlanszaSzerokosc, int iPlanszaWysokosc, int iX, int iY)
		{
		Position oPozycja = new Position(2);
		oPozycja.setX(-1);
		oPozycja.setY(-1);
		Position oWspolrzedneTopLeft;
		Position oWspolrzedneBottomRight;
		//znalezienie X
		for (int i = 0; i < iPlanszaSzerokosc; ++i)
			{
			oWspolrzedneTopLeft = DrawCoordinates.fieldToPixTopLeft(iPanelSzerokosc, iPanelWysokosc, iPlanszaSzerokosc, iPlanszaWysokosc, i, 0);
			oWspolrzedneBottomRight = DrawCoordinates.fieldToPixBottomRight(iPanelSzerokosc, iPanelWysokosc, iPlanszaSzerokosc, iPlanszaWysokosc, i, 0);
		...
		for (int i = 0; i < iPlanszaWysokosc; ++i)
			{
			oWspolrzedneTopLeft = DrawCoordinates.fieldToPixTopLeft(iPanelSzerokosc, iPanelWysokosc, iPlanszaSzerokosc, iPlanszaWysokosc, 0, i);
			oWspolrzedneBottomRight = DrawCoordinates.fieldToPixBottomRight(iPanelSzerokosc, iPanelWysokosc, iPlanszaSzerokosc, iPlanszaWysokosc, 0, i);
	 ...
	 */
	public static Position fieldToPixTopLeft(int iPanelSzerokosc, int iPanelWysokosc, int iPlanszaSzerokosc, int iPlanszaWysokosc, int iXPola, int iYPola)
		{
		Position oPozycja = new Position(2);
		oPozycja.setX(-1);
		oPozycja.setY(-1);
		//obliczenie szerokosci marginesow w pixelach
		int iMarginesPoziomyPx = (int)((float)iPanelSzerokosc * (float)((float)DrawCoordinates.iMargines / 100)); 
		int iMarginesPionowyPx = (int)((float)iPanelWysokosc * (float)((float)DrawCoordinates.iMargines / 100));
	 ...
	 */
	public static Position fieldToPixBottomRight(int iPanelSzerokosc, int iPanelWysokosc, int iPlanszaSzerokosc, int iPlanszaWysokosc, int iXPola, int iYPola)
		{
		return DrawCoordinates.fieldToPixTopLeft(iPanelSzerokosc, iPanelWysokosc, iPlanszaSzerokosc, iPlanszaWysokosc, iXPola + 1, iYPola + 1);
		}
	}
