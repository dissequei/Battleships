...
public class Settings
	...
	public void zapiszUstawieniaDomyslne()
		...
		try
			...
			{
			JOptionPane.showMessageDialog(null, JFrameGameWindow.LANG.getProperty("errorMsg.settings.saveDefault") , JFrameGameWindow.LANG.getProperty("errorMsg.windowTitle"), JOptionPane.ERROR_MESSAGE);
			}
		}
	}
