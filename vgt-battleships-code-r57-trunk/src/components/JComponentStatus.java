...
public class JComponentStatus
	...
	private JComponentShipStatus oListaStatkowGracz;
	private JComponentShipStatus oListaStatkowKomputer;
	 ...
	 */
	public JComponentStatus(GameStatus oStatusGry)
		{
		super();
		...
		JLabel oEtykietaGracz = new JLabel(JFrameGameWindow.LANG.getProperty("gameStatus.Player"), JLabel.CENTER);
		JLabel oEtykietaKomputer = new JLabel(JFrameGameWindow.LANG.getProperty("gameStatus.AI"), JLabel.CENTER);
		JLabel oEtykietaPunktacja = new JLabel(JFrameGameWindow.LANG.getProperty("gameStatus.points"), JLabel.CENTER);
		JLabel oEtykietaFlota = new JLabel(JFrameGameWindow.LANG.getProperty("gameStatus.fleet"), JLabel.LEFT);
		//kolory
		...
		try
			{
			oListaStatkowGracz = new JComponentShipStatus(oStatkiGracz);
			oListaStatkowKomputer = new JComponentShipStatus(oStatkiKomputer);
