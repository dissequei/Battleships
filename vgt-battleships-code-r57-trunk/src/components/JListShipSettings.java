 ...
 * @version 1.0
 */
public class JListShipSettings
	extends JList
	{
	/**
	...
	public void listaDodaj(int iRozmiar) throws ParametrException
		...
		oJListLista.addElement(JListShipSettings.statekNazwa(iRozmiar));
		}
	/**
	...
	public void listaZmien(int iIndex, int iRozmiar) throws ParametrException
		...
		oJListLista.set(iIndex, JListShipSettings.statekNazwa(iRozmiar));
		}
	/**
	...
	public void listaPowieksz(int iIndex) throws ParametrException
		...
		oJListLista.set(iIndex, JListShipSettings.statekNazwa(oListaInt.get(iIndex)));
		}
	/**
	...
	private static String statekNazwa(int iRozmiar) throws ParametrException
		...
		return JFrameGameWindow.LANG.getProperty("shipName.size" + iKlasaStatku) + " ( " + iRozmiar + " )";
		}
	}
